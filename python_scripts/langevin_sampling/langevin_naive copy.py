...
sys.path.append('../../repos/4dvarnet-starter-glorys12')


# IMPORT PRIOR
with initialize(version_base='1.3', config_path="../../repos/4dvarnet-starter-glorys12/config"):
...
# PERFORM GRID_SEARCH
write_path = '/Odyssey/public/glorys/langevin_sampling/tests_2/'
num_samples = 5000
alpha = 0.0000001
