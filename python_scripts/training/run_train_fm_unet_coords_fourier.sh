...
#SBATCH --job-name=fm_coords_fourier
#SBATCH --ntasks-per-node=2
#SBATCH --mem=150G
#SBATCH --cpus-per-gpu=8
#SBATCH --output=/Odyssey/private/d21botvy/job_%j_train_fm_unet_coords_fourier.log
#SBATCH --error=/Odyssey/private/d21botvy/%j_error.txt
#
# Trains config/xp/forecast_DDPM_UNet_1patch_coords_fourier.yaml. Same resources as
...
srun python main.py xp=forecast_DDPM_UNet_1patch_coords_fourier "$@"
